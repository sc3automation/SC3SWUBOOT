...
#define BRING_UP \
	"bring_up=echo ============== Get initial RAM image ========== ;" \
	"dhcp; " \
	"tftpboot 0x83000000 ${fdtfile}; " \
	"tftpboot 0x81000000 uRamdisk; "\
	"setenv bootargs console=${console} root=/dev/ram0 rw;" \
	"bootz 0x82000000 0x81000000 0x83000000;\0"

#define CONFIG_EXTRA_ENV_SETTINGS \
	DEFAULT_LINUX_BOOT_ENV \
	DEFAULT_MMC_TI_ARGS \
	"fdtfile=am437x-mcb11.dtb\0" \
	"boot=mmc\0" \
	"bootpart=0:1\0" \
	"bootdir=\0" \
	"bootfile=zImage\0" \
	"rootpart=0:2\0" \
	"finduuid=part uuid ${boot} ${rootpart} uuid\0" \
